...
export default function MagnificationCalculatorPage() {
                ...
                <div className="bg-emerald-100 rounded-lg p-4 mb-4">
                  <div className="text-center">
                    ...
                    <div className="text-3xl font-bold text-emerald-600">
                      {result.totalMagnification.toFixed(4)}×
                    </div>
            ...
            <div className="space-y-4 text-gray-600">
              <div className="bg-gray-50 rounded-lg p-4">
                <p className="font-mono text-center text-sm mb-2">
                  <strong>Power Factor</strong> = 1 / (1 - d × F)
                </p>
                <p className="font-mono text-center text-sm mb-2">
                  <strong>Shape Factor</strong> = 1 / (1 - (t/n) × F₁)
                </p>
                <p className="font-mono text-center text-sm">
                  <strong>SM</strong> = Power Factor × Shape Factor
                </p>
                <p className="text-xs text-center text-gray-500 mt-2">
                  d = vertex distance (m), F = lens power (D), t = center thickness (m), n = refractive index, F₁ = front curve (D)
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-500">•</span>
                    <span><strong>1.0× = no change</strong> in image size</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-500">•</span>
                    <span><strong>&gt;1.0× = magnification</strong> (plus lenses)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-500">•</span>
                    <span><strong>&lt;1.0× = minification</strong> (minus lenses)</span>
                  </li>
                </ul>
              </div>
            </div>
