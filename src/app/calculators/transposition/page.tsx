...
export default function TranspositionCalculatorPage() {
            ...
            <div className="mt-8 bg-white rounded-xl border border-gray-200 p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div className="text-xs text-gray-500 mt-1">Plus cylinder → Minus cylinder</div>
                </button>
                <button
                ...
                >
                  ...
                  <div className="text-xs text-gray-500 mt-1">Minus cylinder → Plus cylinder</div>
                </button>
                <button
