...
export default function VertexDistanceCalculatorPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'To convert from spectacles (typically 12mm vertex) to contacts (0mm vertex): 1) Use a negative vertex change, 2) For minus powers, the contact lens power will be less minus (e.g., -6.00 spectacles → -5.50 contacts), 3) For plus powers, the contact lens power will be more plus.'
    },
    {
                      ...
                      {explanation && (
                        <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                          ...
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="font-medium">{explanation.origV}mm → {explanation.newV}mm ({explanation.vertexChange > 0 ? '+' : ''}{explanation.vertexChange}mm)</span>
                          </div>
