...
export const metadata: Metadata = {
  title: 'ABO Study Guide 2025 | Topics & Practice Questions',
  description: 'ABO exam study guide covering all test topics. Optics formulas, lens types, frame materials, and practice questions.',
